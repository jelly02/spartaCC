...
data = requests.get('https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query=50%EB%8C%80+%EC%83%9D%EC%9D%BC%EC%84%A0%EB%AC%BC&oquery=40%EB%8C%80+%EC%83%9D%EC%9D%BC%EC%84%A0%EB%AC%BC&tqi=UzBh9lp0JXVssNU9YHKsssssti4-036491', headers=headers)
