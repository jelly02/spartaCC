...
data = requests.get('https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query=%EC%9D%80%EC%82%AC%EB%8B%98+%EC%83%9D%EC%9D%BC%EC%84%A0%EB%AC%BC&oquery=%EB%82%A8%EC%9E%90%EC%B9%9C%EA%B5%AC+%EC%83%9D%EC%9D%BC%EC%84%A0%EB%AC%BC&tqi=UzBi6wp0YihssZOw97dssssstP8-076481', headers=headers)
