...
data = requests.get('https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query=30%EB%8C%80+%EC%83%9D%EC%9D%BC%EC%84%A0%EB%AC%BC&oquery=23%EB%8C%80+%EC%83%9D%EC%9D%BC%EC%84%A0%EB%AC%BC&tqi=UzBh3sp0JXossbv15RGssssstR0-289751', headers=headers)
