...
data = requests.get('https://search.naver.com/search.naver?sm=tab_hty.top&where=nexearch&query=%EC%B9%9C%EA%B5%AC+%EC%83%9D%EC%9D%BC%EC%84%A0%EB%AC%BC&oquery=%EC%9A%B0%EC%A0%95+%EC%84%A0%EB%AC%BC&tqi=UzBilsp0J14ssjAAXM8ssssstz0-320952', headers=headers)
